<?php
  ...
  header('Location:dhomepage.php');
    ...
    if(isset($_POST['update']))
    {
      ...
      $sql="SELECT Driver_password FROM driver WHERE Driver_id='$did' AND Driver_password='$password'";
      $result = mysqli_query($link,$sql);
      $count=mysqli_num_rows($result);
      if($count==1){
        $sql="UPDATE driver SET Driver_password='$newpassword' WHERE Driver_id='$did'";
        $result = mysqli_query($link,$sql);
        echo "<script>alert('Update successfull.');</script>";
        } 
        else {
          echo "<script>alert('Current Password were wrong. Please try again');</script>"; 
        }
      }
  }
 ?>
    ...
    <div class="user_profile_info gray-bg padding_4x4_40">
     ...
     <div class="dealer_info">
        ...
        <p><?php echo $row['Driver_address']; ?><br>
            <?php echo $row['Driver_zip']; ?>&nbsp;<?php echo $row['Driver_city']; ?><br>
