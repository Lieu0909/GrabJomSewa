...
<?php 
	...
	while ($array = mysqli_fetch_array($row)){
		echo "<tr><td>".$array['Main_id']."</td>
					...
					<td><a id='select' href='Dmaintenance.php?mainid=".$array['Main_id'].
					"&vehicleid=".$array['Vehicle_id'].
					"&driverid=".$array['Driver_id'].
					"&maindate=".$array['Main_date'].
					"&maincompany=".$array['Main_company'].
					"&mainservice=".$array['Main_service']."'>Select</a></tr>";
	}
