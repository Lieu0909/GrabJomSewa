...
<?php
	...
	//$newdriverid = $_POST["Did"];
	//$newvehicleid = $_POST["Vid"];
	$main_id = $_SESSION["mainid"];
	$newdate = $_POST["date"];
	$newcompany = $_POST["company"];
	$newservice = $_POST["service"];

	$update= "UPDATE maintenance 
				SET Main_date='$newdate',
					Main_company='$newcompany',
	...
	if (mysqli_query($link,$update))
	{
		...
		echo "<br><br>";
		echo "Please upload your invoice of maintenance ";
		echo "<a href='chooseimg.html'>here</a>";
	}
	else
	{
		echo ("Error: ".mysqli_error($link));
		echo "<br><br>";
		echo "<form action='vehiclelist.php' method='post'>";
