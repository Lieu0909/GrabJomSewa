...
<?php 
	...
	{
			$selectedmainid = $_GET['mainid'];
	}
	
	$delete = "DELETE FROM maintenance WHERE Main_id=$selectedmainid";
	
	if (mysqli_query($link, $delete))
	{
		echo "Maintenance id $selectedmainid has been removed from database.";
		echo "<br>";
	}
	else{
		echo "Error removing record: ".mysqli_error($link);
	}
	...
	while ($array = mysqli_fetch_array($row)){
		echo "<tr><td>".$array['Main_id']."</td>
					...
					<td><a href='uploads/invoice.jpg'>View invoice</a></td>
					<td><a href='deletemain.php?mainid=".$array['Main_id']."'>Remove</a></td></tr>";
	}
