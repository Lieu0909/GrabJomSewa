<?php
  ...
  header('Location:dhomepage.php');
      ...
      if(isset($_POST['updateservices']))
      {
        ...
        $sql="UPDATE services SET Other_services='$oservices' WHERE Driver_id='$did'";
        ...
        <div class="profile_wrap">
          ...
          <form  method="post">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" id="services" name="oservices" type="text">
            </div>
            <div class="form-group">
              <button type="submit" name="updateservices" class="btn">Save Changes <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
