<?php
  ...
  header('Location:index.php');
    ...
    if(isset($_POST['update']))
    {
      ...
      $uid=$_SESSION['uid'];
      $sql="SELECT Customer_password FROM customer WHERE Customer_id='$uid' AND Customer_password='$password'";
      $result = mysqli_query($link,$sql);
      $count=mysqli_num_rows($result);
      if($count==1){
        $sql="UPDATE customer SET Customer_password='$newpassword' WHERE Customer_id='$uid'";
        $result = mysqli_query($link,$sql);
